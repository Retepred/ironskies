...
Province.delete_all
Province.create!(province_template_id: pr1.id, game_id: g.id, faction_id: f1.id)
Province.create!(province_template_id: pr2.id, game_id: g.id, faction_id: f2.id)
Province.create!(province_template_id: pr3.id, game_id: g.id, faction_id: f3.id)
Province.create!(province_template_id: pr4.id, game_id: g.id, faction_id: f4.id)
Province.create!(province_template_id: pr5.id, game_id: g.id, faction_id: f5.id)
Province.create!(province_template_id: pr6.id, game_id: g.id, faction_id: f6.id)
Province.create!(province_template_id: pr7.id, game_id: g.id, faction_id: f7.id)
Province.create!(province_template_id: pr8.id, game_id: g.id, faction_id: f8.id)
